import { VERIFY_URL_INDICATOR, SUBMIT_BUTTON_XPATH, VERIFY_BUTTON_XPATH, CODE_INPUT_SELECTOR, EMAIL_INPUT_XPATH, TYPING_DELAY, USER_EMAIL } from '../config/constants';
